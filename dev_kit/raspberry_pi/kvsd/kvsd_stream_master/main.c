...
start_source()
{
    ...
    set_check_property(x264enc, "key-int-max", 10, NULL);    // Imported from OWM on 2024.02.07.
    ...
    set_check_property(queue1, "max-size-bytes", 64 * 1024, NULL);
    set_check_property(queue1, "max-size-time", 250000000, NULL);
    ...
    set_check_property(queue2, "max-size-bytes", 64 * 1024, NULL);
    set_check_property(queue2, "max-size-time", 250000000, NULL);
    ...
    else    // Imported from OWM on 2024.02.07.
    {
