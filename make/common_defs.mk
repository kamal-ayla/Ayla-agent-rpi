...
TARGET_CFLAGS += -O -Wall -Wunused -Werror -std=gnu99 -Wformat-truncation=0
...
#
TARGET_CFLAGS += -I$(LIBAYLA)/include -I$(LIBPLATFORM)/include -I$(LIBAPP)/include
TARGET_LDFLAGS += -L$(BUILD_ROOT)/lib/platform -L$(BUILD_ROOT)/lib/ayla -L$(BUILD_ROOT)/lib/app
